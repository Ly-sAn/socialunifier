      ...
      <div className='bg-gradient-to-r from-blue-300 to-green-400 border-b'>
        ...
        <div className="container mx-auto">
          <div className="text-center px-3 lg:px-0 p-0.5">
            ...
            <p
              className="leading-normal text-gray-800 text-base md:text-xl lg:text-2xl mb-4"
            >
              Une interface unique pour gérer tous vos réseaux sociaux favoris
        </p>
          ...
          <section className="  py-2 ">
            ...
            >
              <h2
                className="w-full my-2 text-3xl font-black leading-tight text-center text-gray-700 lg:mt-2"
              >
                Nos services
        </h2>
            ...
            Reddit</span>
                ...
                >
                    <path
                      d="M8.695 6.937v1.377H7.687v1.683h1.008V15h2.072V9.997h1.39s.131-.807.194-1.69h-1.576v-1.15c0-.173.226-.404.45-.404h1.128V5h-1.535C8.644 5 8.695 6.685 8.695 6.937z"></path><path d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm0 2C4.477 20 0 15.523 0 10S4.477 0 10 0s10 4.477 10 10-4.477 10-10 10z"
                    /></svg>Facebook
            </span>
              ...
              >
                  <path
                    d="M14.017 0h-8.07A5.954 5.954 0 0 0 0 5.948v8.07a5.954 5.954 0 0 0 5.948 5.947h8.07a5.954 5.954 0 0 0 5.947-5.948v-8.07A5.954 5.954 0 0 0 14.017 0zm3.94 14.017a3.94 3.94 0 0 1-3.94 3.94h-8.07a3.94 3.94 0 0 1-3.939-3.94v-8.07a3.94 3.94 0 0 1 3.94-3.939h8.07a3.94 3.94 0 0 1 3.939 3.94v8.07z"></path><path d="M9.982 4.819A5.17 5.17 0 0 0 4.82 9.982a5.17 5.17 0 0 0 5.163 5.164 5.17 5.17 0 0 0 5.164-5.164A5.17 5.17 0 0 0 9.982 4.82zm0 8.319a3.155 3.155 0 1 1 0-6.31 3.155 3.155 0 0 1 0 6.31z">
                    </path><circle cx="15.156" cy="4.858" r="1.237"></circle></svg>
            Instagram</span>
        ...
        <div className="flex flex-wrap">
          <div className="w-5/6 sm:w-1/2 p-6">
            ...
            <p className="text-gray-600 mb-8">
              Une seule et même interface pour gérer tous vos réseaux sociaux préférés. 
              L'accent est mis sur la facilité et la clarté avec une interface épurée. <br/> <br/>
              Nous allons vous faire aimer créer du contenu à nouveau.
            </p>
          </div>
